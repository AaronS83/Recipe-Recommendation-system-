...
<body>
    ...
    <p id="user-greeting"></p>
      <h2 class="header">Recipe Sharing Platform</h2>
      <div class="log">
  ...
  <div class="container">
    ...
    <div class="user-section">
      <p id="user-greeting"></p>
      <button class="view" type="button" onclick="viewUploadedRecipes()">View Uploaded Recipes</button>
  ...
  <script>
    ...
    var authenticatedUser = {
      name: "Aaron", // Replace with the authenticated user's name
      id: 1
    };
